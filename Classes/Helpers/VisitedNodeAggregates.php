...
final class VisitedNodeAggregates
{
    ...
    /**
     * @param list<ReferenceName> $referenceNames
    ...
    public function add(
        ...
        foreach ($coveredDimensionSpacePoints as $dimensionSpacePoint) {
            $visitedNodeAggregate->addVariant(OriginDimensionSpacePoint::fromDimensionSpacePoint($dimensionSpacePoint), $parentNodeAggregateId, $propertyNames, $referenceNames, $claimedDimensionSpacePoints ?? new DimensionSpacePointSet([$dimensionSpacePoint]));
